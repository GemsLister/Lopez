...
//             <td>${address}</td>
//             <td>
//                 <button class="btn btn-warning"><img src="../images/edit.svg alt="edit-icon"></button>
//                 <button class="btn btn-danger" type="button" value="Delete"><img src="../images/delete.svg alt="delete-icon"></button>
//             </td>
//         `);
